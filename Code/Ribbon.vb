...
'--------------------------------------------------------------------------------------------------------------------
' Purpose:    Extract the entity attributes from all shapes in the file
'
' Ver.  Date            Author              Details
' 1.00  15-Jul-2014     Anthony Duguid     initial version
'--------------------------------------------------------------------------------------------------------------------
#End Region
        ...
        Public Function GetButtonImage(ByVal control As Office.IRibbonControl) As System.Drawing.Bitmap
            Try
                Select Case control.Id.ToString
                    ...
                    Case Is = "btnHelpAsBuilt"
                        Return My.Resources.Resources.HelpAsBuilt
                    Case Is = "btnHelpApi"
                        Return My.Resources.Resources.HelpApi
                    Case Is = "btnHelpEmail"
                        Return My.Resources.Resources.HelpEmail
                    Case Else
                        Return Nothing
                End Select
